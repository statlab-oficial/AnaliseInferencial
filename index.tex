...
\tightlist
\item
  Observar algum fenómeno.
\item
  Formular uma hipótese que explique o fenómeno.
\item
  Coletar dados.
\item
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{População vs.~Amostra}, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, coltitle=black, colback=white, opacityback=0]

\begin{itemize}
\item
  \textbf{População:} O grupo inteiro de indivíduos (sujeitos ou
  unidades), que pode ser existente ou conceptual, sobre o qual
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Parâmetro vs.~Estatística}, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, breakable, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, coltitle=black, colback=white, opacityback=0]
...
Amostra Aleatória Simples (AAS) proveniente de qualquer distribuição com
média \(\mu_{x}\) e variância \(\sigma_{x}^{2}\):
\[E(\overline{X})=\mu_{x} \quad \text{e} \quad Var(\overline{X})=\frac{\sigma_{x}^{2}}{n}.\]

\textbf{Quando os dados são normais (Teorema 7.1):} Para uma AAS
proveniente de uma distribuição normal \(N(\mu_{x},\sigma_{x}^{2})\):
\[\overline{X} \sim N\left(\mu_{x}, \frac{\sigma_{x}^{2}}{n}\right).\]

\textbf{Para amostras de grandes dimensões (Teorema do Limite Central -
Teorema 7.4):} Para um grande tamanho de amostra \(n\) e uma AAS
proveniente de \emph{qualquer} distribuição populacional com variância
finita \(\sigma_{x}^{2} < \infty\):
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Distribuição Qui-quadrado (\(\chi^2\))}, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, coltitle=black, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Distribuição t de Student}, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, coltitle=black, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Distribuição F}, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-note-color!10!white, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, coltitle=black, colback=white, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Teorema do Limite Central}, toptitle=1mm, titlerule=0mm, arc=.35mm, colbacktitle=quarto-callout-important-color!10!white, breakable, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, rightrule=.15mm, toprule=.15mm, bottomrule=.15mm, opacitybacktitle=0.6, left=2mm, coltitle=black, colback=white, opacityback=0]

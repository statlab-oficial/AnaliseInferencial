...
\addcontentsline{toc}{chapter}{BIBLIOGRAFIA COMPLEMENTAR}

\markboth{BIBLIOGRAFIA COMPLEMENTAR}{BIBLIOGRAFIA COMPLEMENTAR}
...
\FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Proporção das 50 bolas que são vermelhas"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Frequência"}\NormalTok{,}
\AttributeTok{title =} \StringTok{"Disttribuição das proporções"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{População vs.~Amostra}, bottomrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, colframe=quarto-callout-important-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Parâmetro vs.~Estatística}, bottomrule=.15mm, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, colframe=quarto-callout-tip-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{O Método de `Força Bruta' para construir uma Distribuição Amostral}, bottomrule=.15mm, opacitybacktitle=0.6]
...
Amostra Aleatória Simples (AAS) proveniente de qualquer distribuição
populacional com média \(\mu_{x}\) e variância \(\sigma_{x}^{2}\):
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Teorema 1: Combinações Lineares}, bottomrule=.15mm, opacitybacktitle=0.6]
...
\textbf{Quando os dados são normais:} Para uma AAS proveniente de uma
distribuição normal \(N(\mu_{x},\sigma_{x}^{2})\):
\[\overline{X} \sim N\left(\mu_{x}, \frac{\sigma_{x}^{2}}{n}\right).\]

\textbf{Exemplo:} Suponha que os níveis de colesterol de homens adultos
sigam uma distribuição \(N(210\,\text{mg/dL}, (37\,\text{mg/dL})^2)\).
...
Sejam \(X_{1},\dots,X_{n}\) uma AAS de uma distribuição com média
...
\textbf{Exemplo Importante (Ensaios de Bernoulli):} Seja \(X = 1\) com
probabilidade \(p\) e \(X = 0\) com probabilidade \((1 - p)\). Então,
dizemos que \(X\) segue uma distribuição de Bernoulli:
...
\tightlist
\item
  Gráfico da f.d.p. (Função de Densidade de Probabilidade)
\end{enumerate}

Desenhe uma representação gráfica da função de massa de probabilidade de
\(X\).
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, colframe=quarto-callout-tip-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Solução Teórica}, bottomrule=.15mm, opacitybacktitle=0.6]

\begin{itemize}
\tightlist
\item
  \textbf{Esperança:}
  \(E(X) = \sum xP(x) = (1 \cdot p) + (0 \cdot (1-p)) = p\)
\item
  \textbf{Variância:} \(Var(X) = E(X^2) - [E(X)]^2 = p - p^2 = p(1-p)\)
\end{itemize}
...
Suponha que foi recolhida uma Amostra Aleatória Simples (AAS)
\(X_1, X_2, \dots, X_{40}\). Indique a distribuição amostral aproximada
de \(\overline{X}\) (geralmente denotada por \(\hat{p} = \overline{X}\),
o que indica que \(\overline{X}\) é uma proporção amostral).

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, colframe=quarto-callout-important-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Aplicação do Teorema do Limite Central}, bottomrule=.15mm, opacitybacktitle=0.6]

De acordo com o Teorema do Limite Central, para uma amostra
suficientemente grande (neste caso \(n=40\)), a distribuição de
\(\hat{p}\) aproxima-se de uma distribuição Normal:

\[\hat{p} \dot{\sim} N\left(p, \frac{p(1-p)}{n}\right)\]

Substituindo \(n=40\):
\[\hat{p} \dot{\sim} N\left(p, \frac{p(1-p)}{40}\right)\]
...
Para estimar a variância populacional \(\sigma^{2}\), utilizamos
\(S^{2}\).

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Distribuição Qui-quadrado (\(\chi^2\))}, bottomrule=.15mm, opacitybacktitle=0.6]

A soma dos quadrados de variáveis normais padronizadas independentes
distribui-se como uma variável aleatória \(\chi^{2}\) (Teorema 7.2): Se
\(Z_{1},...,Z_{\nu}\) forem \(N(0,1)\) independentes, então
\(\sum Z_{i}^{2} \sim \chi^{2}(\nu)\).

\end{tcolorbox}

\textbf{Média e Variância de \(S^{2}\):}
\[E(S^{2})=\sigma_{x}^{2} \quad \text{e} \quad Var(S^{2})=\frac{2\sigma_{x}^{4}}{n-1}\]

\textbf{Quando os dados são normais (Teorema 7.3):}
...
Utilizada frequentemente para determinar a quantos erros padrão a média
amostral se encontra de um valor hipotético \(\mu\).

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Distribuição t de Student}, bottomrule=.15mm, opacitybacktitle=0.6]

(Definição 7.2): Se \(Z \sim N(0,1)\) e \(W \sim \chi^{2}(\nu)\) são
independentes, então: \[T=\frac{Z}{\sqrt{W/\nu}} \sim t(\nu)\]

\end{tcolorbox}

\textbf{Quando os dados são normais:} \(\overline{X}\) e \(S^{2}\) são
independentes. Logo:
\[T=\frac{\overline{X}-\mu}{S/\sqrt{n}} \sim t(n-1)\]

\emph{Nota:} À medida que \(\nu \rightarrow \infty\), a distribuição
...
Na estatística inferencial, é frequentemente do interesse comparar as
variâncias \(\sigma_{1}^{2}\) e \(\sigma_{2}^{2}\) de duas populações.

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, colframe=quarto-callout-note-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Distribuição F}, bottomrule=.15mm, opacitybacktitle=0.6]
...
\textbf{Quando os dados são normais:} Se temos duas amostras
independentes de distribuições normais, então a razão das variâncias
amostrais sobre as variâncias populacionais segue:
\[F=\frac{S_{1}^{2}/\sigma_{1}^{2}}{S_{2}^{2}/\sigma_{2}^{2}} \sim F(n_{1}-1, n_{2}-1)\]

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Prova do Teorema do Limite
Central}\label{prova-do-teorema-do-limite-central}

\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, titlerule=0mm, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, colframe=quarto-callout-important-color-frame, colback=white, arc=.35mm, bottomtitle=1mm, breakable, leftrule=.75mm, opacityback=0, coltitle=black, toptitle=1mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Teorema do Limite Central}, bottomrule=.15mm, opacitybacktitle=0.6]

Seja \(X_{1},X_{2},...,X_{n}\) uma AAS de uma distribuição com média
\(\mu_{x}\) e variância \(\sigma_{x}^{2}<\infty\). Então:
\[\lim_{n\rightarrow\infty} \frac{\overline{X}-\mu_{x}}{\sigma_{x}/\sqrt{n}} = U \sim N(0,1)\]

\end{tcolorbox}

\textbf{Prova:} A prova baseia-se em funções geradoras de momentos
(fgm). A fgm para uma variável aleatória contínua \(Y\) é
\(M(t)=E(e^{tY})\). Sabemos que a fgm de uma variável normal padrão é
\(e^{t^{2}/2}\). Queremos provar que a fgm da nossa estatística converge
para este valor.

\textbf{Passo 1:} Seja \(Z_{i}=\frac{X_{i}-\mu}{\sigma}\). Mostra-se
facilmente que \(E(Z)=0\) e \(Var(Z)=1\). Usando a expansão da Série de
Taylor em torno de \(t=0\):
\[M_Z(t/\sqrt{n}) = 1 + \frac{(t/\sqrt{n})^2}{2!} + R(t/\sqrt{n})\] Onde
o resto \(n \lim_{n\rightarrow\infty} R(t/\sqrt{n}) = 0\).

\textbf{Passo 2:} Definimos a variável padronizada \(U_n\):
...
\textbf{Passo 3:} Substituindo a aproximação de Taylor no limite:
\[\lim_{n\rightarrow\infty} M_{U_{n}}(t) = \lim_{n\rightarrow\infty} \left( 1 + \frac{t^2}{2n} + R(t/\sqrt{n}) \right)^n = e^{t^2/2}\]

\textbf{Passo 4:} Como
\(\lim_{n\rightarrow\infty} M_{U_{n}}(t) = e^{t^2/2}\) e esta é
exatamente a fgm de uma variável Normal Padrão \(N(0,1)\), o teorema
está provado!

\section{Lista Semanal
Obrigatória}\label{lista-semanal-obrigatuxf3ria-1}

...
## Notação e ferramentas de cálculo {.unnumbered}
...
### Somatórios e produtos {.unnumbered}
...
### Funções de uma variável {.unnumbered}
...
### Funções de várias variáveis {.unnumbered}
...
### Aproximação de primeira ordem {.unnumbered}
...
### Aproximação de segunda ordem {.unnumbered}
...
### Vetores e operações {.unnumbered}
...
### Produto interno e norma {.unnumbered}
...
### Matriz identidade e inversa {.unnumbered}
...
### Matrizes simétricas {.unnumbered}
...
### Posto e independência linear {.unnumbered}
...
### Matrizes positivas semidefinidas e positivas definidas {.unnumbered}
...
### Projeção sobre o espaço coluna {.unnumbered}
...
## Transformações vetoriais e matriz jacobiana {.unnumbered}
...
### Relação com o caso univariado {.unnumbered}
...
### Transformação linear {.unnumbered}
...
### Convergência quase certa {.unnumbered}
...
### Convergência em média quadrática {.unnumbered}
...
### Convergência em probabilidade {.unnumbered}
...
### Convergência em distribuição {.unnumbered}
...
## Lei Fraca dos Grandes Números {.unnumbered}
...
### Centralização e mudança de escala {.unnumbered}
...
### Visualização da convergência {.unnumbered}
...
## Lei Fraca dos Grandes Números e Teorema Central do Limite {.unnumbered}
...
### De Taylor ao método delta {.unnumbered}
...
### Visualização do método delta {.unnumbered}
...
### Quando a primeira derivada é nula {.unnumbered}
...
### Ordem em probabilidade {.unnumbered}
...
### Pequena ordem em probabilidade {.unnumbered}
...
### Diferença entre \(O_P\) e \(o_P\) {.unnumbered}
...
### Algumas regras de cálculo {.unnumbered}
...
## Mapa das ferramentas assintóticas {.unnumbered}
...
### Ferramentas de cálculo e álgebra linear {.unnumbered}
...
### Convergência e resultados limites {.unnumbered}
...
### Mapeamento contínuo e Slutsky {.unnumbered}

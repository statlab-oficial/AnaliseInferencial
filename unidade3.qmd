...
3. Sejam $Y_1, \ldots, Y_n$ variáveis aleatórias independentes tais que $Y_i \sim \mathcal{N}(\alpha + \beta x_i, \sigma^2),$
em que os valores $x_i$ são não estocásticos e satisfazem
